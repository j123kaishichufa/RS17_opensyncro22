...
// This class is part of the Apache HttpClient contrib-library, and it is included
// to the OpenSyncro HTTP-package to enable HTTPS to accept self-signed certficates also.
// You can find the latest version of this class from the following url, under heading
// "Examples of SSL customization in HttpClient":
//
// http://jakarta.apache.org/commons/httpclient/sslguide.html
//
// As the javadoc below states, one should be aware of the security implications when
// accepting such certificates.
//
// CHANGES TO THE ORIGINAL EXAMPLE:
// The use of the class "EasyX509TrustManager" was replaced with custom class 
// "AcceptSelfSignedCertificatesX509TrustManager" in the SSLContext-method.
//
// 
