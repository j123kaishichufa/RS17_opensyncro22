...
public class OpenInterfaceIF_exportOrders_Fault_SOAPSerializer extends SOAPFaultInfoSerializer {
    ...
    public OpenInterfaceIF_exportOrders_Fault_SOAPSerializer(boolean encodeType, boolean isNullable) {
        ...
        if (elementName.equals(ns1_AccessDeniedException_QNAME)) {
            if (elementType == null || 
                ...
                if (obj instanceof SOAPDeserializationState) {
                    builder = new smilehouse.openinterface.OpenInterfaceIF_exportOrders_Fault_SOAPBuilder();
