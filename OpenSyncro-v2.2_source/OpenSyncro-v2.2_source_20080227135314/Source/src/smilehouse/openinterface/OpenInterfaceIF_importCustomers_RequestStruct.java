...
public class OpenInterfaceIF_importCustomers_RequestStruct {
    protected smilehouse.openinterface.LoginInfo loginInfo_1;
    protected java.lang.String string_2;
    protected int int_3;
    protected boolean boolean_4;
    
    public OpenInterfaceIF_importCustomers_RequestStruct() {
    }
    
    public OpenInterfaceIF_importCustomers_RequestStruct(smilehouse.openinterface.LoginInfo loginInfo_1, java.lang.String string_2, int int_3, boolean boolean_4) {
