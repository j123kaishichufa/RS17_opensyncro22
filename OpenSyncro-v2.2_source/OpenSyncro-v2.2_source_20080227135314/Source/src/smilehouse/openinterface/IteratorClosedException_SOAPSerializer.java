...
public class IteratorClosedException_SOAPSerializer extends ObjectSerializerBase implements Initializable {
    ...
    public IteratorClosedException_SOAPSerializer(QName type, boolean encodeType, boolean isNullable, String encodingStyle) {
    ...
    public Object doDeserialize(SOAPDeserializationState state, XMLReader reader,
        ...
        smilehouse.openinterface.IteratorClosedException instance = null;
        Object messageTemp = null;
        smilehouse.openinterface.IteratorClosedException_SOAPBuilder builder = null;
        Object member;
        ...
        if (reader.getState() == XMLReader.START) {
            if (elementName.equals(ns1_message_QNAME)) {
                ...
                if (member instanceof SOAPDeserializationState) {
                    if (builder == null) {
                        builder = new smilehouse.openinterface.IteratorClosedException_SOAPBuilder();
                    }
        ...
        if (isComplete) {
            instance = new smilehouse.openinterface.IteratorClosedException((java.lang.String)messageTemp);
        } else {
    ...
    public void doSerializeAttributes(Object obj, XMLWriter writer, SOAPSerializationContext context) throws Exception {
        smilehouse.openinterface.IteratorClosedException instance = (smilehouse.openinterface.IteratorClosedException)obj;
