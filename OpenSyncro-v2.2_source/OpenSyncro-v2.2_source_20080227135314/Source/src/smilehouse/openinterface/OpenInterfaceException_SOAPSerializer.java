...
public class OpenInterfaceException_SOAPSerializer extends ObjectSerializerBase implements Initializable {
    ...
    public OpenInterfaceException_SOAPSerializer(QName type, boolean encodeType, boolean isNullable, String encodingStyle) {
    ...
    public Object doDeserialize(SOAPDeserializationState state, XMLReader reader,
        ...
        smilehouse.openinterface.OpenInterfaceException instance = null;
        Object messageTemp = null;
        smilehouse.openinterface.OpenInterfaceException_SOAPBuilder builder = null;
        Object member;
        ...
        if (reader.getState() == XMLReader.START) {
            if (elementName.equals(ns1_message_QNAME)) {
                ...
                if (member instanceof SOAPDeserializationState) {
                    if (builder == null) {
                        builder = new smilehouse.openinterface.OpenInterfaceException_SOAPBuilder();
                    }
        ...
        if (isComplete) {
            instance = new smilehouse.openinterface.OpenInterfaceException((java.lang.String)messageTemp);
        } else {
