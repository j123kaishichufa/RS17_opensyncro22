...
public class OpenInterfaceIF_iterate_Fault_SOAPSerializer extends SOAPFaultInfoSerializer {
    ...
    private static final QName ns1_IteratorClosedException_QNAME = new QName("http://www.smilehouse.com/wsdl", "IteratorClosedException");
    private static final QName ns2_IteratorClosedException_TYPE_QNAME = new QName("http://www.smilehouse.com/types", "IteratorClosedException");
    private CombinedSerializer ns2_myIteratorClosedException_SOAPSerializer;
    private CombinedSerializer ns2_myIteratorClosedException_SOAPSerializer_Serializer;
    ...
    public OpenInterfaceIF_iterate_Fault_SOAPSerializer(boolean encodeType, boolean isNullable) {
    ...
    public void initialize(InternalTypeMappingRegistry registry) throws Exception {
        ...
        ns2_myIteratorClosedException_SOAPSerializer = (CombinedSerializer)registry.getSerializer(SOAPConstants.NS_SOAP_ENCODING, smilehouse.openinterface.IteratorClosedException.class, ns2_IteratorClosedException_TYPE_QNAME);
        ns2_myIteratorClosedException_SOAPSerializer_Serializer = ns2_myIteratorClosedException_SOAPSerializer.getInnermostSerializer();
    }
    ...
    protected Object deserializeDetail(SOAPDeserializationState state, XMLReader reader,
        ...
        if (elementName.equals(ns1_AccessDeniedException_QNAME)) {
            if (elementType == null || 
                ...
                if (obj instanceof SOAPDeserializationState) {
                    builder = new smilehouse.openinterface.OpenInterfaceIF_iterate_Fault_SOAPBuilder();
        ...
        } else if (elementName.equals(ns1_IteratorClosedException_QNAME)) {
            if (elementType == null || 
                (elementType.equals(ns2_myIteratorClosedException_SOAPSerializer.getXmlType()) ||
                (ns2_myIteratorClosedException_SOAPSerializer_Serializer instanceof ArraySerializerBase &&
                elementType.equals(SOAPConstants.QNAME_ENCODING_ARRAY)) ) ) {
                obj = ns2_myIteratorClosedException_SOAPSerializer.deserialize(ns1_IteratorClosedException_QNAME, reader, context);
                if (obj instanceof SOAPDeserializationState) {
                    builder = new smilehouse.openinterface.OpenInterfaceIF_iterate_Fault_SOAPBuilder();
                    state = registerWithMemberState(instance, state, obj,
                        SMILEHOUSE_OPENINTERFACE_ITERATORCLOSEDEXCEPTION_INDEX, builder);
                    isComplete = false;
                } else {
                    detail = obj;
                }
    ...
    protected void serializeDetail(Object detail, XMLWriter writer, SOAPSerializationContext context)
        ...
        else if (detail instanceof smilehouse.openinterface.IteratorClosedException) {
            ns2_myIteratorClosedException_SOAPSerializer_Serializer.serialize(detail, ns1_IteratorClosedException_QNAME, null, writer, context);
        }
