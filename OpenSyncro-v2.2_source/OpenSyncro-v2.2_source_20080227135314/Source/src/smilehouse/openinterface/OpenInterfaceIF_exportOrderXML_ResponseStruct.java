...
public class OpenInterfaceIF_exportOrderXML_ResponseStruct {
    protected smilehouse.openinterface.ExportResult result;
    
    public OpenInterfaceIF_exportOrderXML_ResponseStruct() {
    }
    
    public OpenInterfaceIF_exportOrderXML_ResponseStruct(smilehouse.openinterface.ExportResult result) {
        this.result = result;
    }
