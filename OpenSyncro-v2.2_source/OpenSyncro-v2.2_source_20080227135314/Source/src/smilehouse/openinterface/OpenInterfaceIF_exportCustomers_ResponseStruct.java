...
public class OpenInterfaceIF_exportCustomers_ResponseStruct {
    protected smilehouse.openinterface.ExportResult result;
    
    public OpenInterfaceIF_exportCustomers_ResponseStruct() {
    }
    
    public OpenInterfaceIF_exportCustomers_ResponseStruct(smilehouse.openinterface.ExportResult result) {
        this.result = result;
    }
