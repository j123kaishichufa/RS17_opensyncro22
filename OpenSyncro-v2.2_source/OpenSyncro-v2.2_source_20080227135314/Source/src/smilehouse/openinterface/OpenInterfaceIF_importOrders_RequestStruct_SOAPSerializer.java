...
public class OpenInterfaceIF_importOrders_RequestStruct_SOAPSerializer extends ObjectSerializerBase implements Initializable {
    ...
    public OpenInterfaceIF_importOrders_RequestStruct_SOAPSerializer(QName type, boolean encodeType, boolean isNullable, String encodingStyle) {
    ...
    public Object doDeserialize(SOAPDeserializationState state, XMLReader reader,
        ...
        smilehouse.openinterface.OpenInterfaceIF_importOrders_RequestStruct instance = new smilehouse.openinterface.OpenInterfaceIF_importOrders_RequestStruct();
        smilehouse.openinterface.OpenInterfaceIF_importOrders_RequestStruct_SOAPBuilder builder = null;
        Object member;
        ...
        for (int i=0; i<6; i++) {
            ...
            if (elementName.equals(ns1_LoginInfo_1_QNAME)) {
                ...
                if (member instanceof SOAPDeserializationState) {
                    if (builder == null) {
                        builder = new smilehouse.openinterface.OpenInterfaceIF_importOrders_RequestStruct_SOAPBuilder();
                    }
    ...
    public void doSerializeAttributes(Object obj, XMLWriter writer, SOAPSerializationContext context) throws Exception {
        smilehouse.openinterface.OpenInterfaceIF_importOrders_RequestStruct instance = (smilehouse.openinterface.OpenInterfaceIF_importOrders_RequestStruct)obj;
