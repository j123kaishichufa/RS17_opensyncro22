...
public class OpenInterfaceIF_importPricelist_RequestStruct {
    protected smilehouse.openinterface.LoginInfo loginInfo_1;
    protected java.lang.String string_2;
    protected int int_3;
    
    public OpenInterfaceIF_importPricelist_RequestStruct() {
    }
    
    public OpenInterfaceIF_importPricelist_RequestStruct(smilehouse.openinterface.LoginInfo loginInfo_1, java.lang.String string_2, int int_3) {
