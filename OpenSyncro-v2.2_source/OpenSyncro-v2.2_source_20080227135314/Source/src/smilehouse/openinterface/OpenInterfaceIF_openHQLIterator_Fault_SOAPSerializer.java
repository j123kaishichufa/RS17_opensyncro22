...
public class OpenInterfaceIF_openHQLIterator_Fault_SOAPSerializer extends SOAPFaultInfoSerializer {
    ...
    public OpenInterfaceIF_openHQLIterator_Fault_SOAPSerializer(boolean encodeType, boolean isNullable) {
        ...
        if (elementName.equals(ns1_AccessDeniedException_QNAME)) {
            if (elementType == null || 
                ...
                if (obj instanceof SOAPDeserializationState) {
                    builder = new smilehouse.openinterface.OpenInterfaceIF_openHQLIterator_Fault_SOAPBuilder();
