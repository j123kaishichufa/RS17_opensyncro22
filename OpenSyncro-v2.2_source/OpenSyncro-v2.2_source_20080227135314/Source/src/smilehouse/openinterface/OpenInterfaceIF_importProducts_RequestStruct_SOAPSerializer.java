...
public class OpenInterfaceIF_importProducts_RequestStruct_SOAPSerializer extends ObjectSerializerBase implements Initializable {
    ...
    private static final QName ns1_arrayOfString_4_QNAME = new QName("", "arrayOfString_4");
    ...
    private static final QName ns1_boolean_6_QNAME = new QName("", "boolean_6");
    ...
    public OpenInterfaceIF_importProducts_RequestStruct_SOAPSerializer(QName type, boolean encodeType, boolean isNullable, String encodingStyle) {
    ...
    public Object doDeserialize(SOAPDeserializationState state, XMLReader reader,
        ...
        smilehouse.openinterface.OpenInterfaceIF_importProducts_RequestStruct instance = new smilehouse.openinterface.OpenInterfaceIF_importProducts_RequestStruct();
        smilehouse.openinterface.OpenInterfaceIF_importProducts_RequestStruct_SOAPBuilder builder = null;
        Object member;
        ...
        for (int i=0; i<6; i++) {
            ...
            if (elementName.equals(ns1_LoginInfo_1_QNAME)) {
                ...
                if (member instanceof SOAPDeserializationState) {
                    if (builder == null) {
                        builder = new smilehouse.openinterface.OpenInterfaceIF_importProducts_RequestStruct_SOAPBuilder();
                    }
            ...
            if (elementName.equals(ns1_arrayOfString_4_QNAME)) {
                member = ns2_myns2_ArrayOfstring__StringArray_SOAPSerializer1.deserialize(ns1_arrayOfString_4_QNAME, reader, context);
                if (member instanceof SOAPDeserializationState) {
                    if (builder == null) {
                        builder = new smilehouse.openinterface.OpenInterfaceIF_importProducts_RequestStruct_SOAPBuilder();
                    }
                    state = registerWithMemberState(instance, state, member, myARRAYOFSTRING_4_INDEX, builder);
                    isComplete = false;
                } else {
                    instance.setArrayOfString_4((java.lang.String[])member);
                }
                reader.nextElementContent();
                continue;
            }
            ...
            if (elementName.equals(ns1_boolean_6_QNAME)) {
                member = ns3_myns3__boolean__boolean_Boolean_Serializer.deserialize(ns1_boolean_6_QNAME, reader, context);
                instance.setBoolean_6(((Boolean)member).booleanValue());
                reader.nextElementContent();
                continue;
            } else {
                throw new DeserializationException("soap.unexpectedElementName", new Object[] {ns1_boolean_6_QNAME, elementName});
            }
        }
    ...
    public void doSerializeAttributes(Object obj, XMLWriter writer, SOAPSerializationContext context) throws Exception {
        smilehouse.openinterface.OpenInterfaceIF_importProducts_RequestStruct instance = (smilehouse.openinterface.OpenInterfaceIF_importProducts_RequestStruct)obj;
    ...
    public void doSerializeInstance(Object obj, XMLWriter writer, SOAPSerializationContext context) throws Exception {
        ...
        ns2_myns2_ArrayOfstring__StringArray_SOAPSerializer1.serialize(instance.getArrayOfString_4(), ns1_arrayOfString_4_QNAME, null, writer, context);
        ...
        ns3_myns3__boolean__boolean_Boolean_Serializer.serialize(new Boolean(instance.isBoolean_6()), ns1_boolean_6_QNAME, null, writer, context);
    }
}
