...
public class OpenInterfaceIF_exportOrders_ResponseStruct {
    protected smilehouse.openinterface.ExportResult result;
    
    public OpenInterfaceIF_exportOrders_ResponseStruct() {
    }
    
    public OpenInterfaceIF_exportOrders_ResponseStruct(smilehouse.openinterface.ExportResult result) {
        this.result = result;
    }
