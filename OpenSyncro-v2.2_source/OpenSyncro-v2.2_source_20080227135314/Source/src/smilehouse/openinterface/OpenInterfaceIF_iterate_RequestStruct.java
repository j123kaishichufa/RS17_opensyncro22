...
public class OpenInterfaceIF_iterate_RequestStruct {
    protected smilehouse.openinterface.LoginInfo loginInfo_1;
    protected java.lang.String string_2;
    protected int int_3;
    
    public OpenInterfaceIF_iterate_RequestStruct() {
    }
    
    public OpenInterfaceIF_iterate_RequestStruct(smilehouse.openinterface.LoginInfo loginInfo_1, java.lang.String string_2, int int_3) {
