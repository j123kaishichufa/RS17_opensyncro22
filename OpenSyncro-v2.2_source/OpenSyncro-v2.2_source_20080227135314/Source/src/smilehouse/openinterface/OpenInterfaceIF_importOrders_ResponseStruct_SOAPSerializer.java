...
public class OpenInterfaceIF_importOrders_ResponseStruct_SOAPSerializer extends ObjectSerializerBase implements Initializable {
    ...
    public OpenInterfaceIF_importOrders_ResponseStruct_SOAPSerializer(QName type, boolean encodeType, boolean isNullable, String encodingStyle) {
    ...
    public Object doDeserialize(SOAPDeserializationState state, XMLReader reader,
        ...
        smilehouse.openinterface.OpenInterfaceIF_importOrders_ResponseStruct instance = new smilehouse.openinterface.OpenInterfaceIF_importOrders_ResponseStruct();
        smilehouse.openinterface.OpenInterfaceIF_importOrders_ResponseStruct_SOAPBuilder builder = null;
        Object member;
        ...
        if (reader.getState() == XMLReader.START) {
            ...
            if (member instanceof SOAPDeserializationState) {
                if (builder == null) {
                    builder = new smilehouse.openinterface.OpenInterfaceIF_importOrders_ResponseStruct_SOAPBuilder();
                }
    ...
    public void doSerializeAttributes(Object obj, XMLWriter writer, SOAPSerializationContext context) throws Exception {
        smilehouse.openinterface.OpenInterfaceIF_importOrders_ResponseStruct instance = (smilehouse.openinterface.OpenInterfaceIF_importOrders_ResponseStruct)obj;
