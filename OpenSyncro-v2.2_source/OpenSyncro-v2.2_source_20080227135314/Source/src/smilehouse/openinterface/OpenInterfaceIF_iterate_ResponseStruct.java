...
public class OpenInterfaceIF_iterate_ResponseStruct {
    protected smilehouse.openinterface.ExportResult result;
    
    public OpenInterfaceIF_iterate_ResponseStruct() {
    }
    
    public OpenInterfaceIF_iterate_ResponseStruct(smilehouse.openinterface.ExportResult result) {
        this.result = result;
    }
