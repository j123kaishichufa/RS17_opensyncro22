...
public class OpenInterfaceIF_invokeEvent_RequestStruct_SOAPSerializer extends ObjectSerializerBase implements Initializable {
    ...
    private static final QName ns1_Object_3_QNAME = new QName("", "Object_3");
    private static final QName ns3_anyType_TYPE_QNAME = SchemaConstants.QNAME_TYPE_URTYPE;
    ...
    public OpenInterfaceIF_invokeEvent_RequestStruct_SOAPSerializer(QName type, boolean encodeType, boolean isNullable, String encodingStyle) {
    ...
    public Object doDeserialize(SOAPDeserializationState state, XMLReader reader,
        ...
        smilehouse.openinterface.OpenInterfaceIF_invokeEvent_RequestStruct instance = new smilehouse.openinterface.OpenInterfaceIF_invokeEvent_RequestStruct();
        smilehouse.openinterface.OpenInterfaceIF_invokeEvent_RequestStruct_SOAPBuilder builder = null;
        Object member;
        ...
        for (int i=0; i<3; i++) {
            ...
            if (elementName.equals(ns1_LoginInfo_1_QNAME)) {
                ...
                if (member instanceof SOAPDeserializationState) {
                    if (builder == null) {
                        builder = new smilehouse.openinterface.OpenInterfaceIF_invokeEvent_RequestStruct_SOAPBuilder();
                    }
            ...
            if (elementName.equals(ns1_Object_3_QNAME)) {
                member = ns3_myns3_anyType__DynamicSerializer.deserialize(ns1_Object_3_QNAME, reader, context);
                if (member instanceof SOAPDeserializationState) {
                    if (builder == null) {
                        builder = new smilehouse.openinterface.OpenInterfaceIF_invokeEvent_RequestStruct_SOAPBuilder();
                    }
                    state = registerWithMemberState(instance, state, member, myOBJECT_3_INDEX, builder);
                    isComplete = false;
                } else {
                    instance.setObject_3((java.lang.Object)member);
                }
                reader.nextElementContent();
                continue;
            } else {
                throw new DeserializationException("soap.unexpectedElementName", new Object[] {ns1_Object_3_QNAME, elementName});
            }
        }
    ...
    public void doSerializeAttributes(Object obj, XMLWriter writer, SOAPSerializationContext context) throws Exception {
        smilehouse.openinterface.OpenInterfaceIF_invokeEvent_RequestStruct instance = (smilehouse.openinterface.OpenInterfaceIF_invokeEvent_RequestStruct)obj;
    ...
    public void doSerializeInstance(Object obj, XMLWriter writer, SOAPSerializationContext context) throws Exception {
        ...
        ns3_myns3_anyType__DynamicSerializer.serialize(instance.getObject_3(), ns1_Object_3_QNAME, null, writer, context);
    }
}
