...
public class OpenInterfaceIF_openHQLIterator_RequestStruct_SOAPSerializer extends ObjectSerializerBase implements Initializable {
    ...
    public OpenInterfaceIF_openHQLIterator_RequestStruct_SOAPSerializer(QName type, boolean encodeType, boolean isNullable, String encodingStyle) {
    ...
    public Object doDeserialize(SOAPDeserializationState state, XMLReader reader,
        ...
        smilehouse.openinterface.OpenInterfaceIF_openHQLIterator_RequestStruct instance = new smilehouse.openinterface.OpenInterfaceIF_openHQLIterator_RequestStruct();
        smilehouse.openinterface.OpenInterfaceIF_openHQLIterator_RequestStruct_SOAPBuilder builder = null;
        Object member;
        ...
        for (int i=0; i<3; i++) {
            ...
            if (elementName.equals(ns1_LoginInfo_1_QNAME)) {
                ...
                if (member instanceof SOAPDeserializationState) {
                    if (builder == null) {
                        builder = new smilehouse.openinterface.OpenInterfaceIF_openHQLIterator_RequestStruct_SOAPBuilder();
                    }
            ...
            if (elementName.equals(ns1_long_3_QNAME)) {
                member = ns3_myns3__long__long_Long_Serializer.deserialize(ns1_long_3_QNAME, reader, context);
                instance.setLong_3(((Long)member).longValue());
                reader.nextElementContent();
                continue;
            } else {
                throw new DeserializationException("soap.unexpectedElementName", new Object[] {ns1_long_3_QNAME, elementName});
            }
        }
    ...
    public void doSerializeAttributes(Object obj, XMLWriter writer, SOAPSerializationContext context) throws Exception {
        smilehouse.openinterface.OpenInterfaceIF_openHQLIterator_RequestStruct instance = (smilehouse.openinterface.OpenInterfaceIF_openHQLIterator_RequestStruct)obj;
    ...
    public void doSerializeInstance(Object obj, XMLWriter writer, SOAPSerializationContext context) throws Exception {
        ...
        ns3_myns3__long__long_Long_Serializer.serialize(new Long(instance.getLong_3()), ns1_long_3_QNAME, null, writer, context);
    }
}
